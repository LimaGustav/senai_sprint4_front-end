...
pessoa.apresentacao = function(){
    var art
    var ano
    if (pessoa.sexo == "Feminino") art = "a"
    else art = "o"

    if (pessoa.idade == 1) ano = "ano"
    else ano = "anos"

    return `Olá, eu sou ${art} ${pessoa.nome + " " + pessoa.sobrenome},
tenho ${pessoa.idade} ${ano}, ${pessoa.altura}, meu peso é ${pessoa.peso} e,
